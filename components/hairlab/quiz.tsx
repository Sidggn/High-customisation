...
const issueImages: Record<string, string> = {
  // Hair-only macro contact sheets keep every quiz choice visual and personal.
  straight: '/hair-issues/texture-options.png',
  wavy: '/hair-issues/texture-options.png',
  curly: '/hair-issues/texture-options.png',
  coily: '/hair-issues/texture-options.png',
  fine: '/hair-issues/texture-options.png',
  medium: '/hair-issues/texture-options.png',
  thick: '/hair-issues/texture-options.png',
  low: '/hair-issues/condition-options.png',
  high: '/hair-issues/condition-options.png',
  dry: '/hair-issues/scalp-options.png',
  balanced: '/hair-issues/scalp-options.png',
  oily: '/hair-issues/scalp-options.png',
  veryOily: '/hair-issues/scalp-options.png',
  never: '/hair-issues/scalp-options.png',
  occasionally: '/hair-issues/scalp-options.png',
  frequently: '/hair-issues/scalp-options.png',
  almostAlways: '/hair-issues/scalp-options.png',
  minimal: '/hair-issues/condition-options.png',
  mild: '/hair-issues/condition-options.png',
  moderate: '/hair-issues/condition-options.png',
  significant: '/hair-issues/condition-options.png',
  notAtAll: '/hair-issues/condition-options.png',
  slightly: '/hair-issues/condition-options.png',
  moderately: '/hair-issues/condition-options.png',
  significantly: '/hair-issues/condition-options.png',
  veryLittle: '/hair-issues/condition-options.png',
  sometimes: '/hair-issues/condition-options.png',
  often: '/hair-issues/condition-options.png',
  daily: '/hair-issues/condition-options.png',
  soft: '/hair-issues/condition-options.png',
  slightlyDry: '/hair-issues/condition-options.png',
  quiteDry: '/hair-issues/condition-options.png',
  extremelyDry: '/hair-issues/condition-options.png',
  healthy: '/hair-issues/condition-options.png',
  slight: '/hair-issues/condition-options.png',
  noticeable: '/hair-issues/condition-options.png',
  severe: '/hair-issues/condition-options.png',
  rarely: '/hair-issues/condition-options.png',
  breakage: '/hair-issues/condition-options.png',
  hairFall: '/hair-issues/condition-options.png',
  dandruff: '/hair-issues/scalp-options.png',
  dryness: '/hair-issues/condition-options.png',
  frizz: '/hair-issues/condition-options.png',
  damage: '/hair-issues/condition-options.png',
  thinning: '/hair-issues/condition-options.png',
  dullness: '/hair-issues/condition-options.png',
  greying: '/hair-issues/condition-options.png',
  oilyScalp: '/hair-issues/scalp-options.png',
  dryScalp: '/hair-issues/scalp-options.png',
  weakness: '/hair-issues/condition-options.png',
}
